...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V3"), false);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V9"), false);
  expectedBN->addEdge(this->data->varIndex("V17"), this->data->varIndex("V3"), false);
...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V8"), false);
  expectedBN->addEdge(this->data->varIndex("V15"), this->data->varIndex("V6"), false);
...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V18"), this->data->varIndex("V30"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V25"), this->data->varIndex("V24"), false);
  expectedBN->addEdge(this->data->varIndex("V26"), this->data->varIndex("V30"), false);
  expectedBN->addEdge(this->data->varIndex("V30"), this->data->varIndex("V27"), false);
