/**
 * @file GetPCNetworks.hpp
 * @brief Definitions of expected networks learned using GetPC algorithm.
...
using GetPCAlgorithm = GetPC<DiscreteData<Counter, uint8_t>, uint8_t, UintSet<uint8_t>>;

template <>
BayesianNetwork<uint8_t>*
ChildData<GetPCAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  expectedBN->addEdge(this->data->varIndex("V2"), this->data->varIndex("V8"), true);
  expectedBN->addEdge(this->data->varIndex("V2"), this->data->varIndex("V16"), true);
  expectedBN->addEdge(this->data->varIndex("V2"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V8"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V9"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V17"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V18"), true);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V19"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V20"), true);
  expectedBN->addEdge(this->data->varIndex("V7"), this->data->varIndex("V15"), true);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V15"), true);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V16"), true);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V18"), true);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V19"), true);
...
template <>
BayesianNetwork<uint8_t>*
InsuranceData<GetPCAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V9"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V18"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V19"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V25"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V7"), this->data->varIndex("V9"), true);
  expectedBN->addEdge(this->data->varIndex("V7"), this->data->varIndex("V24"), true);
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V21"), true);
  expectedBN->addEdge(this->data->varIndex("V9"), this->data->varIndex("V12"), true);
  expectedBN->addEdge(this->data->varIndex("V9"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V10"), this->data->varIndex("V13"), true);
  expectedBN->addEdge(this->data->varIndex("V11"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V13"), this->data->varIndex("V27"), true);
  expectedBN->addEdge(this->data->varIndex("V15"), this->data->varIndex("V17"), true);
  expectedBN->addEdge(this->data->varIndex("V15"), this->data->varIndex("V20"), true);
  expectedBN->addEdge(this->data->varIndex("V20"), this->data->varIndex("V21"), true);
  expectedBN->addEdge(this->data->varIndex("V23"), this->data->varIndex("V24"), true);
...
template <>
BayesianNetwork<uint8_t>*
MildewData<GetPCAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  expectedBN->addEdge(this->data->varIndex("V1"), this->data->varIndex("V2"), true);
  expectedBN->addEdge(this->data->varIndex("V4"), this->data->varIndex("V26"), true);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V12"), true);
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V13"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V18"), true);
  expectedBN->addEdge(this->data->varIndex("V13"), this->data->varIndex("V26"), true);
  expectedBN->addEdge(this->data->varIndex("V13"), this->data->varIndex("V27"), true);
  expectedBN->addEdge(this->data->varIndex("V15"), this->data->varIndex("V16"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V22"), this->data->varIndex("V21"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V26"), this->data->varIndex("V32"), true);
...
template <>
BayesianNetwork<uint8_t>*
AlarmData<GetPCAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V4"), this->data->varIndex("V7"), true);
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V7"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V10"), this->data->varIndex("V11"), true);
  expectedBN->addEdge(this->data->varIndex("V10"), this->data->varIndex("V35"), true);
  expectedBN->addEdge(this->data->varIndex("V11"), this->data->varIndex("V12"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V16"), this->data->varIndex("V33"), true);
  expectedBN->addEdge(this->data->varIndex("V26"), this->data->varIndex("V17"), false);
  expectedBN->addEdge(this->data->varIndex("V18"), this->data->varIndex("V25"), true);
  expectedBN->addEdge(this->data->varIndex("V18"), this->data->varIndex("V31"), true);
  expectedBN->addEdge(this->data->varIndex("V20"), this->data->varIndex("V19"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V25"), this->data->varIndex("V32"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V32"), this->data->varIndex("V33"), true);
  expectedBN->addEdge(this->data->varIndex("V33"), this->data->varIndex("V34"), true);
