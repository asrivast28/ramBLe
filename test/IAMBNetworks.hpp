/**
 * @file IAMBNetworks.hpp
 * @brief Definitions of expected networks learned using IAMB algorithm.
 ...
 */
#ifndef TEST_IAMBNETWORKS_HPP_
#define TEST_IAMBNETWORKS_HPP_

#include "BlanketLearning.hpp"
#include "NetworkData.hpp"


using IAMBAlgorithm = IAMB<DiscreteData<Counter, uint8_t>, uint8_t, UintSet<uint8_t>>;

template <>
BayesianNetwork<uint8_t>*
ChildData<IAMBAlgorithm>::expectedBN(
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V18"), this->data->varIndex("V19"), true);
  return expectedBN;
}

template <>
BayesianNetwork<uint8_t>*
InsuranceData<IAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
...
template <>
BayesianNetwork<uint8_t>*
MildewData<IAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  expectedBN->addEdge(this->data->varIndex("V1"), this->data->varIndex("V2"), true);
...
template <>
BayesianNetwork<uint8_t>*
AlarmData<IAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V20"), this->data->varIndex("V21"), false);
  expectedBN->addEdge(this->data->varIndex("V20"), this->data->varIndex("V24"), false);
