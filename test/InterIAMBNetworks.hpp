/**
 * @file InterIAMBNetworks.hpp
 * @brief Definitions of expected networks learned using InterIAMB algorithm.
 ...
 */
#ifndef TEST_INTERIAMBNETWORKS_HPP_
#define TEST_INTERIAMBNETWORKS_HPP_

#include "BlanketLearning.hpp"
#include "NetworkData.hpp"


using InterIAMBAlgorithm = InterIAMB<DiscreteData<Counter, uint8_t>, uint8_t, UintSet<uint8_t>>;

template <>
BayesianNetwork<uint8_t>*
ChildData<InterIAMBAlgorithm>::expectedBN(
)
{
...
template <>
BayesianNetwork<uint8_t>*
InsuranceData<InterIAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V4"), true);
  expectedBN->addEdge(this->data->varIndex("V3"), this->data->varIndex("V9"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V15"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V25"), this->data->varIndex("V7"), false);
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V21"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V16"), this->data->varIndex("V15"), false);
  expectedBN->addEdge(this->data->varIndex("V15"), this->data->varIndex("V17"), false);
...
template <>
BayesianNetwork<uint8_t>*
MildewData<InterIAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  expectedBN->addEdge(this->data->varIndex("V1"), this->data->varIndex("V2"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V16"), this->data->varIndex("V15"), false);
  expectedBN->addEdge(this->data->varIndex("V17"), this->data->varIndex("V15"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V23"), this->data->varIndex("V21"), false);
...
template <>
BayesianNetwork<uint8_t>*
AlarmData<InterIAMBAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V36"), this->data->varIndex("V15"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V19"), this->data->varIndex("V20"), false);
  expectedBN->addEdge(this->data->varIndex("V21"), this->data->varIndex("V20"), false);
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V20"), false);
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V21"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V27"), this->data->varIndex("V29"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V29"), this->data->varIndex("V30"), true);
...
#endif // TEST_INTERIAMBNETWORKS_HPP_
