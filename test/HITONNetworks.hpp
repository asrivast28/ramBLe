/**
 * @file HITONNetworks.hpp
 * @brief Definitions of expected networks learned using HITON algorithm.
...
using HITONAlgorithm = HITON<DiscreteData<Counter, uint8_t>, uint8_t, UintSet<uint8_t>>;

template <>
BayesianNetwork<uint8_t>*
ChildData<HITONAlgorithm>::expectedBN(
)
{
...
template <>
BayesianNetwork<uint8_t>*
InsuranceData<HITONAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V9"), this->data->varIndex("V5"), false);
  expectedBN->addEdge(this->data->varIndex("V12"), this->data->varIndex("V5"), false);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V17"), false);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V25"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V7"), false);
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V10"), true);
...
template <>
BayesianNetwork<uint8_t>*
MildewData<HITONAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V35"), true);
  ...
  expectedBN->addEdge(this->data->varIndex("V30"), this->data->varIndex("V34"), true);
  return expectedBN;
}

template <>
BayesianNetwork<uint8_t>*
AlarmData<HITONAlgorithm>::expectedBN(
)
{
  auto* expectedBN = new BayesianNetwork<uint8_t>(this->data->varNames());
  ...
  expectedBN->addEdge(this->data->varIndex("V20"), this->data->varIndex("V21"), true);
  expectedBN->addEdge(this->data->varIndex("V21"), this->data->varIndex("V24"), true);
  expectedBN->addEdge(this->data->varIndex("V22"), this->data->varIndex("V23"), false);
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V23"), false);
