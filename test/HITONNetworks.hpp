...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V17"), this->data->varIndex("V5"), false);
  expectedBN->addEdge(this->data->varIndex("V25"), this->data->varIndex("V5"), false);
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V6"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V10"), this->data->varIndex("V8"), false);
