...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V6"), this->data->varIndex("V20"), false);
  expectedBN->addEdge(this->data->varIndex("V14"), this->data->varIndex("V20"), false);
...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V8"), this->data->varIndex("V10"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V24"), this->data->varIndex("V25"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V9"), this->data->varIndex("V25"), false);
...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V11"), this->data->varIndex("V28"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V33"), this->data->varIndex("V28"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V26"), this->data->varIndex("V13"), false);
...
)
{
  ...
  expectedBN->addEdge(this->data->varIndex("V34"), this->data->varIndex("V33"), false);
  expectedBN->addEdge(this->data->varIndex("V36"), this->data->varIndex("V37"), false);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V2"), false);
  expectedBN->addEdge(this->data->varIndex("V5"), this->data->varIndex("V3"), false);
  expectedBN->addEdge(this->data->varIndex("V4"), this->data->varIndex("V5"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V32"), this->data->varIndex("V20"), false);
  expectedBN->addEdge(this->data->varIndex("V31"), this->data->varIndex("V25"), false);
  expectedBN->addEdge(this->data->varIndex("V25"), this->data->varIndex("V32"), false);
  ...
  expectedBN->addEdge(this->data->varIndex("V31"), this->data->varIndex("V32"), false);
  expectedBN->addEdge(this->data->varIndex("V33"), this->data->varIndex("V32"), false);
